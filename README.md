...
+ Create a config file based on this:
    + [https://github.com/h8pewou/legacy_webos/blob/main/metube-webos-config.php](https://github.com/h8pewou/legacy_webos/blob/main/metube-webos-config.php)
...
+ Create your docker-compose.yaml based on this:
    + [https://raw.githubusercontent.com/h8pewou/legacy_webos/main/docker-compose.yml](https://raw.githubusercontent.com/h8pewou/legacy_webos/main/docker-compose.yml)
+ This works without any modifications but it only contains the bare minimum configuration.
    + `nano docker-compose.yml`

+ Download the Dockerfile:
    + [https://raw.githubusercontent.com/h8pewou/legacy_webos/main/Dockerfile](https://raw.githubusercontent.com/h8pewou/legacy_webos/main/Dockerfile)

+ Create the settings/000-default.conf
    + `mkdir settings`
    + `nano settings/000-default.conf`
...
+ Set permissions on downloads
    + `chown www-data downloads`
